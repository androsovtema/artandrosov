# AGENTS.md — Art Androsov Portfolio
...
This AGENTS.md handles the **technical migration plan** (Astro structure, URL mapping, etc.). CONTEXT.md handles **who Art is and what he wants the site to say**. Both are required for high-quality work on this project.
